...
if (!defined('APP_KEY')) header("Location: 403.php");
...
<body>
	...
	<div class="errorWrapper">
		...
		<div class="errorContent">
		    ...
		    <span class="purple">kartatopia.com</span>
			</span>
	...
	<script type="text/javascript">function leave() {  window.location = "<?php echo APP_DIR; ?>";} setTimeout("leave()", 5000);</script>
</body>
</html>