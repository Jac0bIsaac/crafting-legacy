			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
<form method="post"
action="index.php?module=volunteers&action=<?php echo $views['formAction']; ?>&volunteerId=<?php if (isset($views['ID'])) 
	echo (int)$views['ID']; ?>&sessionId=<?php if (isset($views['token'])) echo htmlspecialchars($views['token']); ?>"
								...
								<input type="hidden" name="level" value="<?php if ( isset($views['level']))  echo htmlspecialchars($views['level']); ?>" />
